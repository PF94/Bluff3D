...
//----------------------------------------------------------------------------
    bool Matrix3::inverse(Matrix3 &rkInverse, float fTolerance) const {
        ...
        for (int iRow = 0; iRow < 3; iRow++) {
                for (int iCol = 0; iCol < 3; iCol++)rkInverse[iRow][iCol] *= fInvDet;
            }
    ...
    void Matrix3::singularValueDecomposition(Matrix3 &kL, Vector3 &kS,
        ...
        for (iRow = 0; iRow < 3; iRow++) {
                if (kS[iRow] < 0.0) {
                    ...
                    for (iCol = 0; iCol < 3; iCol++)kR[iRow][iCol] = -kR[iRow][iCol];
                }
            }
    }
...
//----------------------------------------------------------------------------
    void Matrix3::singularValueComposition(const Matrix3 &kL,
        ...
        // product S*R
        for (iRow = 0; iRow < 3; iRow++) {
                for (iCol = 0; iCol < 3; iCol++)kTmp[iRow][iCol] = kS[iRow] * kR[iRow][iCol];
            }
        ...
        for (iRow = 0; iRow < 3; iRow++) {
                for (iCol = 0; iCol < 3; iCol++) {
                        ...
                        for (int iMid = 0; iMid < 3; iMid++)elt[iRow][iCol] += kL[iRow][iMid] * kTmp[iMid][iCol];
                    }
            }
    }
...
//----------------------------------------------------------------------------
    void Matrix3::qDUDecomposition(Matrix3 &kQ,
        ...
        if (fDet < 0.0) {
            for (int iRow = 0; iRow < 3; iRow++)for (int iCol = 0; iCol < 3; iCol++)kQ[iRow][iCol] = -kQ[iRow][iCol];
        }
...
//----------------------------------------------------------------------------
    float Matrix3::spectralNorm() const {
        ...
        for (iRow = 0; iRow < 3; iRow++) {
                for (iCol = 0; iCol < 3; iCol++)kP[iRow][iCol] *= fInvPmax;
            }
