...
namespace G3D {
    ...
    GLight
    GLight::point(const Vector3 &pos, const Color3 &color, double constAtt, double linAtt, double quadAtt, bool s,
                  bool d) {
        GLight L;
    ...
    GLight
    GLight::spot(const Vector3 &pos, const Vector3 &pointDirection, double cutOffAngleDegrees, const Color3 &color,
                 double constAtt, double linAtt, double quadAtt, bool s, bool d) {
        GLight L;
        L.position = Vector4(pos, 1);
