 ...
 */
        ...
        public:
            ...
            void
            AddComponent(LPCSTR type, LPCSTR caption, DWORD style, DWORD exStyle, int x, int y, int w, int h, WORD id) {
 ...
 */
    static int guiPrompt(
        ...
        *pNew = '\0';
        ...
        int ret = DialogBoxIndirectParam(module, dialogTemplate, NULL, (DLGPROC) PromptDlgProc,
                                         (DWORD) (size_t) &params);
