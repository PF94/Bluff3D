...
#include "G3D/Log.h"
#include <png.h> // don't use such an ancient version
...
//libpng required function signature
    static void png_read_data(
        ...
        ((BinaryInput *) png_get_io_ptr(png_ptr))->readBytes(length, data);
    }
...
//libpng required function signature
    ...
    void GImage::encodePNG(
        ...
        if (this->height > (int) (PNG_UINT_32_MAX / sizeof(png_bytep)))
    ...
    void GImage::decodePNG(
        ...
        png_get_IHDR(png_ptr, info_ptr, (png_uint_32 * ) & png_width, (png_uint_32 * ) & png_height, &bit_depth,
                     &color_type,
