...
///////////////////////////////////////////////////
    ...
    void GPUProgram::genPrograms(int num, unsigned int *id) const {
        ...
        switch (extension) {
            case NVIDIA: alwaysAssertM(glGenProgramsNV != NULL,
                                       "Requires an NVIDIA card with the GL_NV_vertex_program extension");
        ...
        for (int b = 0; b < bindingTable.bindingArray.size(); ++b) {
                ...
                if (binding.source == VARIABLE) {
                    ...
                    alwaysAssertM(arg.type == binding.type,
                                  ...
                                  "\" was declared as type " + GPUProgram::toString(binding.type) +
                                  " and the values supplied" +
                    ...
                    if (binding.slot != BindingTable::Binding::UNASSIGNED) {
                        switch (binding.type) {
                            ...
                            case FLOAT2X2: alwaysAssertM(false, "FLOAT2X2 not implemented.");
                                break;
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    void GPUProgram::BindingTable::parseVariable(TextInput &ti) {
        ...
        abort:;// Jump here if anything unexpected is encountered during parsing
    }
