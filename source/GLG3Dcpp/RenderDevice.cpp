...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    void RenderDevice::push2D(const FramebufferRef &fb) {
        const Rect2D &viewport = fb.notNull() ? fb->rect2DBounds() : Rect2D::xywh(0, 0, _window->width(),
                                                                                  _window->height());
        push2D(fb, viewport);
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void RenderDevice::setState(
        ...
        if (newState.stencil != state.stencil) {
            ...
            setStencilOp(
                    newState.stencil.frontStencilFail, newState.stencil.frontStencilZFail,
                    newState.stencil.frontStencilZPass,
                    newState.stencil.backStencilFail, newState.stencil.backStencilZFail,
                    newState.stencil.backStencilZPass);
