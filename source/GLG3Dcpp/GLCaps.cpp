 ...
 */
    ...
    GLCaps::Vendor GLCaps::computeVendor() {
        ...
        if (s == "ATI Technologies Inc.") { // what about modern amd cards?
            return ATI;
 ...
 */
    ...
    std::string GLCaps::getDriverVersion() {
        // original code would check ancient driver dlls which would just
        // cause the driver version to show up as "Unknown" on modern systems
