...
/**
  ...
  */
    ...
    public:
        ...
        enum Format {
            JPEG, BMP, TGA, PCX, ICO, PNG, PPM_ASCII, PPM, AUTODETECT, UNKNOWN
        };
    ...
    public:
        ...
        */
        ...
        /** Overwrites every pixel with one of the two colors in a checkerboard pattern.
            ...
            */
        static void
        makeCheckerboard(GImage &im, int checkerSize = 1, const Color4uint8 &color1 = Color4uint8(255, 255, 255, 255),
...
/** Fast conversion; the output has 1/2 the size of the input in each direction. Assumes in != out.
 See G3D::BAYER_G8B8_R8G8_to_R8G8B8_MHC for a much better result. */
    inline void G3D_DEPRECATED
    BAYER_G8B8_R8G8_to_Quarter_R8G8B8(int inWidth, int inHeight, const uint8 *in, uint8 *out) {
...
*/
    inline void G3D_DEPRECATED
    Quarter_R8G8B8_to_BAYER_G8B8_R8G8(int inWidth, int inHeight, const uint8 *in, uint8 *out) {
