 ...
 */
    ...
    public:
        ...
        enum RenderMode {
            RENDER_SOLID, RENDER_WIREFRAME, RENDER_POINTS, RENDER_CURRENT
        };
    ...
    public:
        ...
        enum BlendEq {
            BLENDEQ_MIN, BLENDEQ_MAX, BLENDEQ_ADD,
            BLENDEQ_SUBTRACT, BLENDEQ_REVERSE_SUBTRACT,
            BLENDEQ_CURRENT
        };

        enum StencilOp {
            STENCIL_INCR_WRAP, STENCIL_DECR_WRAP,
        ...
        enum ShadeMode {
            SHADE_FLAT, SHADE_SMOOTH, SHADE_CURRENT
        };
        ...
        */
        enum CombineMode {
            TEX_REPLACE, TEX_BLEND, TEX_INTERPOLATE, TEX_ADD, TEX_MODULATE,
        ...
        */
        ...
        public:
            ...
            RenderState(int width = 1, int height = 1,
                        int highestTextureUnitThatChanged = GLCaps::G3D_MAX_TEXTURE_UNITS);
