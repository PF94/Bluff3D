...
/** 
  ...
  */
    ...
    public:
        ...
        enum Type {
            NONE = 0, MESH = 1, BOX, CYLINDER, SPHERE, RAY, CAPSULE, PLANE, AXES
        };
 ...
 */
    ...
    public:
        ...
        virtual void render(RenderDevice *rd, const CoordinateFrame &cframe, Color4 solidColor = Color4(.5, .5, 0, .5),
    ...
    public:
        ...
        /** Creates a box of the given extents centered at the origin. */
        inline BoxShape(float x, float y, float z) : geometry(Vector3(-x / 2, -y / 2, -z / 2),
                                                              Vector3(x / 2, y / 2, z / 2)) {}
    ...
    public:
        ...
        virtual Sphere boundingSphere() const {
            Sphere s(geometry.center(),
                     G3D::abs((geometry.center() - geometry.getPoint1()).magnitude()) + geometry.radius);
            return s;
        }
