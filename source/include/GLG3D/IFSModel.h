 ...
 */
    ...
    public:
         ...
         */
        static IFSModelRef create(const std::string &filename, const Vector3 &scale = Vector3(1, 1, 1),
                                  const CoordinateFrame &cframe = CoordinateFrame(), const bool weld = true);

        static IFSModelRef
        create(const std::string &filename, const double scale, const CoordinateFrame &cframe = CoordinateFrame(),
        ...
        /**
         ...
         which are slower.
         */
        virtual PosedModelRef
        pose(const CoordinateFrame &cframe, const GMaterial &material, bool perVertexNormals = true);
